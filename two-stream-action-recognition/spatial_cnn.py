...
class Spatial_CNN():
    ...
    def build_model(self):
        ...
        #build model
        self.model = resnet101(pretrained=False, channel=3, num_classes=self.num_classes).cuda()
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            if is_best:
                ...
                with open('record/spatial/'+self.prefix+'_spatial_video_preds.pickle','wb') as f:
            ...
            },is_best,'record/spatial/'+self.prefix+'_checkpoint.pth.tar','record/spatial/'+self.prefix+'_model_best.pth.tar')
    ...
    def train_1epoch(self):
        ...
        for i, (data_dict,label) in enumerate(progress):
            ...
            # compute output
            output = Variable(torch.zeros(len(data_dict['img1']),self.num_classes).float()).cuda()
        ...
        record_info(info, 'record/spatial/'+self.prefix+'_rgb_train.csv','train')
    ...
    def validate_1epoch(self):
        ...
        record_info(info, 'record/spatial/'+self.prefix+'_rgb_test.csv','test')
...
if __name__=='__main__':
    # main(ds_path='/home/bassel/data/office-actions/office_actions_19/short_clips/resized_frms_224/',
    ...
    main(ds_path='/home/bassel/data/office-actions/office_actions_19/short_clips/stabilized_resized_frms_224/',
         trainfile='/home/bassel/data/office-actions/office_actions_19/short_clips/labels/side_only_trainlist.txt',
         testfile='/home/bassel/data/office-actions/office_actions_19/short_clips/labels/side_only_testlist.txt',
